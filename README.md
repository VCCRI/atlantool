...
```
$ java -jar atlantool.jar index <bam-path>

$ java -jar atlantool.jar view <bam-path> -n <qname-to-search>
or
$ java -jar atlantool.jar view <bam-path> -f <file-containing-qnames>
```
